...
public class Mp3PlayerActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// this.seek.setOnSeekBarChangeListener(new
	...
	private class OnSeekBarChangeListenerImpl implements
		...
		public void onProgressChanged(SeekBar seekBar, int progress,
			...
			Mp3PlayerActivity.this.text.append("正在拖动，当前值："
					+ seekBar.getProgress());
		}

		public void onStartTrackingTouch(SeekBar seekBar) {
			// TODO Auto-generated method stub
			Mp3PlayerActivity.this.text.append("开始拖动，当前值："
					+ seekBar.getProgress());
		}

		public void onStopTrackingTouch(SeekBar seekBar) {
			// TODO Auto-generated method stub
			Mp3PlayerActivity.this.text.append("停止拖动，当前值："
					+ seekBar.getProgress());
		}
